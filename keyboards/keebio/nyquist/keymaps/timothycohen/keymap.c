...
// tco_v06. LAYOUT_ortho_4x12 wrote my right keyboard's top row to the 5th (and missing) bottom row of the left keyboard
// something must be mismatched with #define LAYOUT_ortho_4x12
// quick fixed by writing in the extra row of empty keys and switching from LAYOUT_ortho_4x12 to LAYOUT
